...
def Extract_GDToday_date(from_date: datetime, to_date: datetime):
    with open('GDToday.csv', mode='w', encoding='utf-8', newline='') as csv_file:
        ...
        while from_date <= datetime_obj:
            i += 1
            url = f"https://www.newsgd.com/node_5c070fdd03?cms_node_post_list_page={i}"
...
Extract_GDToday_date(from_date, to_date)
"""
#Extract_GDToday_all()